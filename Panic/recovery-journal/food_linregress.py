...
with open('food-diary', 'r') as f:
  ...
  L = filter(lambda row: row['alcohol'] and row['sweets'], list(reader)[:31])
...
pylab.savefig('alcohol-and-sugar.png')
pylab.close()
...
pylab.savefig('alcohol-vs-sugar.png')
pylab.close()
...
pylab.savefig('alcohol-today-vs-yesterday.png')
pylab.close()
